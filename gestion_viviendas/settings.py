"""
Django settings for gestion_viviendas project.
...
# En un entorno de producción, esta variable DEBE estar configurada.
# Para desarrollo, se usa un valor por defecto si la variable no existe.
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-@c0=z&_q&a+5z%&n&i#8z&b(e^$p&o!_@q#b&x)g(v&h^n'
)
...
ROOT_URLCONF = "gestion_viviendas.urls"
...
WSGI_APPLICATION = "gestion_viviendas.wsgi.application"
